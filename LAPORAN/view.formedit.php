                ...
                <div class="row">
                    <div class="col-lg-12">
                       DUTA TRANSFORMASI INSANI
						...
						<input type="hidden" name="id_panitia" value="<?php echo $data_panitia['id_panitia'];?>"/>
						<center>
							...
							<tr>
								...
								<td><input type="date" name="tanggal_lahir" value="<?php echo $data_panitia['tanggal_lahir'];?>"/></td>
							</tr>
